...
import analytics from "./utils/firebase_config";
						...
						<div
							...
							<div className="flex items-center mx-6 justify-evenly">
								...
								<FaPlusCircle
									size={32}
									onClick={() =>
										addItem(index, product.availableQTY)
									}
									className="cursor-pointer"
								/>
							</div>
		...
		return (
			<div className="max-h-[78vh] overflow-y-scroll no-scrollbar">
					...
					<div>
						...
						<div className="font-medium flex justify-between items-center mb-4 border-b pb-4">
							...
							<div className="flex items-center gap-4">
								{couponValid && (
									<div className="text-[#327531] border border-[#A4FF8D] bg-[#CAFFC1] px-4 py-1 rounded-md flex items-center gap-4">
										{" "}
										{discountPercent}% Coupon Applied
									</div>
								)}
								<p>GH₵ {Math.floor(discountValue)}</p>
							</div>
						</div>
					</div>
				)}
				<div
					className={`${
						!couponVisible && "mt-4"
					} font-medium flex justify-between items-center mb-4 border-b pb-4`}>
					<p>Total</p>
				...
				{couponVisible && (
					<div className="mt-4">
						...
						<div className="relative flex">
							...
							/>
							{couponValid && (
								<div className="absolute right-2 top-2 text-[#327531] border border-[#A4FF8D] bg-[#CAFFC1] px-4 py-1 rounded-md flex items-center gap-4">
	...
	return (
		<div className="">
            ...
            <FaTimes className="cursor-pointer" onClick={() => { setminQuantNotif(false) }} />
				...
				{allDocs.length === 0 && <LoadingAnimation />}
				<div
					className={`mt-4 mx-[16px] b-[16px] md:m-[64px] grid ${
						less360 ? " grid-cols-1" : " grid-cols-2"
					} md:grid-cols-3 gap-[16px] md:gap-8 md:mt-4`}>
						...
						<div className="w-full justify-center text-center place-items-center">
							...
							<div className="flex flex-col text-center">
								...
								<p className="text-[14px] w-[75%] mt-2 m-auto text-gray-600 text-center">
									Our team will reach out to you in order to
									finalize your order
								</p>
							</div>
						</div>
